...
import java.awt.Font;
  ...
  * @author lamon
  */
 public class pongexample2 extends JComponent implements ActionListener {
    ...
    Font biggerFont = new Font("arial", Font.BOLD, 36);
     ...
     private void checkForCollision() {
        ...
        // NOTE: % 360 just makes sure we don't go over 360 degrees+        // does the ball hit paddle1
     ...
     public static void main(String[] args) {
         ...
         pongexample2 game = new pongexample2();
     }
 }